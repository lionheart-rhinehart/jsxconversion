...
- **Hype videos:** `AA HYPE VIDEO.m4v`, `4-13 HYPE.mp4`, `AA LOGO.MP4`, plus action clips (box jumps, bear crawl, agility drill).
...
| `assets/` | Logo, action photography, video clips. |
