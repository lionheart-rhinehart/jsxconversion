// training-scene — generated example. Distinct layout family (squint test).
export default function Example() {
  return (
    <div style={{ width: 1080, height: 1920, position: "relative", overflow: "hidden", background: "#f4f4f2" }}>
      <div style={{ position: "absolute", left: 56, right: 56, top: 80, height: 1040, borderRadius: 28, overflow: "hidden", boxShadow: "0 24px 60px rgba(0,0,0,0.18)" }}>      <img src="./assets/ex-031-training-scene-0.jpg" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }} /></div>
