...
export default function Example() {
  return (
    <div style={{ width: 1080, height: 1920, position: "relative", overflow: "hidden", background: "#000" }}>
      <img src="./assets/ex-007-action-hero-a-0.jpg" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }} />
      ...
      <div style={{ position: "absolute", left: 64, right: 64, bottom: 210 }}>
        ...
        <div style={{ fontFamily: "Anton", color: "#fff", fontSize: 140, lineHeight: 0.92, textTransform: "uppercase", textShadow: "0 2px 24px rgba(0,0,0,0.75)" }}>Faster by<br/>the fall</div>
      </div>
    </div>
  );
}
