// proof-collage — generated example. Distinct layout family (squint test).
export default function Example() {
  return (
    <div style={{ width: 1080, height: 1920, position: "relative", overflow: "hidden", background: "#ececed" }}>
      <div style={{ position: "absolute", inset: 0, padding: 48, boxSizing: "border-box" }}>
