      ...
      <div style={{ position: "absolute", inset: 0, background: "#0c0c0c", padding: 40, boxSizing: "border-box" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gridGap: 16 }}>
          <div style={{ position: "relative", height: 440, borderRadius: 14, overflow: "hidden" }}>
            <img src="./assets/ex-016-proof-collage-a-0.jpg" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }} />
          ...
          <div style={{ position: "relative", height: 440, borderRadius: 14, overflow: "hidden" }}>
            <img src="./assets/ex-016-proof-collage-a-1.jpg" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }} />
            <div style={{ position: "absolute", left: 0, right: 0, bottom: 0, padding: "16px 14px", background: "linear-gradient(0deg, rgba(0,0,0,0.85), rgba(0,0,0,0))", fontFamily: "Geist", color: "#fff", fontSize: 24, fontWeight: 600 }}>"Best decision we made this year."</div>
          </div>
          <div style={{ position: "relative", height: 440, borderRadius: 14, overflow: "hidden" }}>
            <img src="./assets/ex-016-proof-collage-a-2.jpg" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }} />
            <div style={{ position: "absolute", left: 0, right: 0, bottom: 0, padding: "16px 14px", background: "linear-gradient(0deg, rgba(0,0,0,0.85), rgba(0,0,0,0))", fontFamily: "Geist", color: "#fff", fontSize: 24, fontWeight: 600 }}>"Best decision we made this year."</div>
          </div>
          <div style={{ position: "relative", height: 440, borderRadius: 14, overflow: "hidden" }}>
            <img src="./assets/ex-016-proof-collage-a-3.jpg" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }} />
            <div style={{ position: "absolute", left: 0, right: 0, bottom: 0, padding: "16px 14px", background: "linear-gradient(0deg, rgba(0,0,0,0.85), rgba(0,0,0,0))", fontFamily: "Geist", color: "#fff", fontSize: 24, fontWeight: 600 }}>"Best decision we made this year."</div>
          </div>
        </div>
      </div>
