// coach-portrait — generated example. Distinct layout family (squint test).
export default function Example() {
  return (
    <div style={{ width: 1080, height: 1920, position: "relative", overflow: "hidden", background: "#000" }}>
      <div style={{ position: "absolute", left: 0, top: 0, bottom: 0, width: "52%", overflow: "hidden" }}>      <img src="./assets/ex-037-coach-portrait-0.jpg" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }} /></div>
